...
Q_CONSTINIT static const qt_meta_stringdata_LoginScreen_t qt_meta_stringdata_LoginScreen = {
    {
        ...
        QT_MOC_LITERAL(44, 15),  // "showInputFields"
        QT_MOC_LITERAL(60, 16),  // "cleanupAnimation"
        QT_MOC_LITERAL(77, 24),  // "togglePasswordVisibility"
        QT_MOC_LITERAL(102, 15),  // "getIconFromPath"
        QT_MOC_LITERAL(118, 8)   // "iconName"
    },
    "LoginScreen",
    "loginSuccessful",
    "",
...
Q_CONSTINIT const QMetaObject LoginScreen::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_LoginScreen_t,
        ...
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'cleanupAnimation'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'togglePasswordVisibility'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'getIconFromPath'
...
void LoginScreen::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->showInputFields(); break;
        case 3: _t->cleanupAnimation(); break;
        case 4: _t->togglePasswordVisibility(); break;
        case 5: { QIcon _r = _t->getIconFromPath((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])));
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &LoginScreen::loginSuccessful; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
