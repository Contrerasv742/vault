...
void EncryptPage::setupUI()
{
    ...
    encryptionAlgorithmComboBox->addItems(QStringList() << "caesar" << "vigenere" << "rot13" << "rsa");
...
void EncryptPage::encryptText()
{
    ...
    // Here you would call your encryption function based on the selected algorithm
    ...
    // std::string encryptedText = cipherOptable[selectedAlgorithm.toStdString()](textToBeEncrypted.toStdString(), generatedPassword.toStdString());
