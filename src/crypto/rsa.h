...
// TODO: Ensure we are actually keeping objects and their respective variables
// private and public
...
/**
 * @class RSA
 * @brief Provides RSA encryption and decryption capabilities with large number
 * support
 */
class RSA {
private:
...
public:
     ...
     *          Sets up n (modulus), e (public exponent), and d (private
     * exponent)
     */
    RSA();
